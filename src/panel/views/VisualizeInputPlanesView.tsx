...
const visualizeInputPlanesView: React.FC<
  VisualizeInputPlanesViewProps
> = ({}) => {
  useEffect(() => {}, []);
...
/*     await miro.board.createStickyNote({
  ...
  return (
    <div className="">
      <p>
        After you analyzed the frames, you can explore the perspectives directly
        in Miro or export the analyzed data.
      </p>
      <div className="">
